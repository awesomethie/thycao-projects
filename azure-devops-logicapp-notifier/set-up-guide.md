...
- select the event **Work item updated**, for Filters, configure as below
...
- select *History* after testing

![Service Hook History](images/servicehook-history.png)

- copy the JSON payload from the *Event*

![Payload JSON](images/payload-json.png)
...
Go back to Logic app designer

- select *Use sample payload to generate schema

![Use Sample Payload](images/user-sample-payload-option.png)

- paste the JSON and let Azure do the rest

![Paste JSON](images/paste-json-payload.png)
